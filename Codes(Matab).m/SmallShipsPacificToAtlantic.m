...
for i = 1:NumberOfShips
    ...
    % Calculate distance to Miraflores Lock in kilometers
    ShipsToGate_Dist_km = sqrt((Ship_X - MirafloresLock_X)^2 + (Ship_Y - MirafloresLock_Y)^2);
...
[new_sorted_distances, new_sorted_indices] = sort(distances_km , 'descend');
